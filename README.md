...
ArchiQ는 Amazon Q Developer와 통합되어 고객의 현재 AWS 아키텍처를 자동으로 분석하고 개선 방안을 제시하는 도구입니다. 서울 리전 최적화 및 간소화된 사용자 경험을 제공합니다. AWS 프로파일을 선택하여 멀티 계정 환경에서도 편리하게 사용할 수 있습니다.
